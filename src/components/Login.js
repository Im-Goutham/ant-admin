  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit} className="login-form">
        ...
        <FormItem>
          <a className="login-form-forgot linkText" onClick={()=>{this.props.changeForm('Forget')}}>Forgot password</a>
          <Button type="primary" htmlType="submit" className="login-form-button" onClick={()=>{this.props.history.push('dashboard')}}>
            Log in
          </Button>
          Or <a  className='linkText' onClick={()=>{this.props.changeForm('Register')}}>register now!</a>
        </FormItem>
      </Form>
    );
  }
